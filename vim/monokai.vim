...
let s:myfg        = { "gui": "#8F918F", "cterm": "241" }
let s:mybg        = { "gui": "#1c1c1c", "cterm": "234" }
...
" editor
call s:h("Normal",        { "fg": s:white,      "bg": s:mybg })
...
call s:h("LineNr",        { "fg": s:myfg,       "bg": s:mybg })
call s:h("CursorLineNr",  { "fg": s:orange,     "bg": s:mybg })
